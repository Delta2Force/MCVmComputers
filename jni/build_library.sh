...
if [[ "$OSTYPE" == "linux-gnu"* ]]; then
	...
	gcc -g -Wall -I"$JAVA_DIR/include" -I"$JAVA_DIR/include/win32" -Isdk/bindings/c/include -Isdk/bindings/mscom/include -Isdk/bindings/c/glue src/c/vbhook_VBHook.c -o bin/vbhook.o
	gcc -g -Wall -Isdk/bindings/c/include -Isdk/bindings/mscom/include -Isdk/bindings/c/glue sdk/bindings/c/glue/VBoxCAPIGlue.c -o bin/VBoxCAPIGlue.o
	gcc -g -Wall -Isdk/bindings/c/include -Isdk/bindings/mscom/include -Isdk/bindings/c/glue sdk/bindings/mscom/lib/VirtualBox_i.c -o bin/VirtualBox_i.o
