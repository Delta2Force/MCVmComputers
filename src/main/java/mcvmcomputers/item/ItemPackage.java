	...
	public Text getName(ItemStack stack) {
		if(stack.getTag() != null) {
			if(stack.getTag().contains("packaged_item")) {
				return new LiteralText("Packaged ").formatted(Formatting.GRAY).append(new TranslatableText(Registry.ITEM.get(new Identifier(stack.getTag().getString("packaged_item"))).getTranslationKey()).formatted(Formatting.GREEN));
			}
		}
