...
public class ItemList {
	...
	public static final OrderableItem ITEM_FLATSCREENTV_NOSTAND = new ItemFlatscreenTVNoStand(new Settings().group(MOD_ITEM_GROUP_PERIPHERALS));
	...
	public static final List<Item> PLACABLE_ITEMS = Arrays.asList(PC_CASE, PC_CASE_SIDEPANEL, ITEM_KEYBOARD, ITEM_MOUSE, ITEM_CRTSCREEN, ITEM_FLATSCREEN, ITEM_FLATSCREENTV_NOSTAND);
	...
	public static void init() {
		...
		registerItem("flatscreentv_nostand", ITEM_FLATSCREENTV_NOSTAND);
