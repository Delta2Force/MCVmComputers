...
public class CRTScreenRender extends EntityRenderer<EntityCRTScreen>{
	...
	public void render(EntityCRTScreen entity, float yaw, float tickDelta, MatrixStack matrices,
		...
		if(MainInitializer.vmTextureIdentifier != null) {
			matrices.push();
			...
			VertexConsumer vertexConsumer = vertexConsumers.getBuffer(RenderLayer.getText(MainInitializer.vmTextureIdentifier));
